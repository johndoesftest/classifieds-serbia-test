...
const ListingDetailPage: React.FC<ListingDetailPageProps> = ({ listing, onNavigate, listings, currentUser, favorites, onToggleFavorite, onDeleteListing, onAuthSuccess }) => {
               ...
               <div className="bg-white rounded-xl shadow-lg p-6 text-center">
                  ...
                  <div className="mt-6 space-y-3">
                      ...
                      <button 
                        ...
                        className="w-full flex items-center justify-center gap-x-2 bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-lg transition-colors"
                      >
