// The key for storing the listings database in localStorage.
...
const INITIAL_MOCK_LISTINGS: Listing[] = [
  // New listings for existing users
  {
    id: '61',
    title: 'Sony PlayStation 4 Slim 500GB + 2 Džojstika',
    description: 'Prodajem očuvan PS4 Slim, radi savršeno. Uz konzolu idu dva originalna DualShock 4 džojstika i svi potrebni kablovi. Nije čipovan. Idealan za poklon.',
    price: 180,
    currency: 'EUR',
    category: 'elektronika',
    location: 'Beograd',
    condition: 'used',
    images: ['https://picsum.photos/seed/ps4slim/800/600'],
  ...
  {
    id: '62',
    title: 'Original Michael Kors torba - kao nova',
    description: 'Prodajem originalnu Michael Kors torbu, model Jet Set. Nošena svega par puta, bez ikakvih oštećenja. Boja je vanila. Dolazi sa originalnom vrećicom za čuvanje.',
    price: 12000,
    currency: 'RSD',
    category: 'kuca-i-basta',
    location: 'Beograd',
    condition: 'used',
    images: ['https://picsum.photos/seed/mkbag/800/600'],
    postedDate: '2024-07-25T11:30:00Z',
  ...
  {
    id: '64',
    title: 'Mountain Bike Capriolo Monitor FSL',
    description: 'Prodajem očuvan planinski bicikl, točkovi 26". Shimano oprema, prednji amortizer. Bicikl je servisiran i spreman za vožnju. Gume su dobre.',
    price: 150,
    currency: 'EUR',
    category: 'kuca-i-basta',
    location: 'Novi Sad',
    condition: 'used',
    images: ['https://picsum.photos/seed/mtbcapriolo/800/600'],
    postedDate: '2024-07-25T09:15:00Z',
  ...
  {
    id: '63',
    title: 'Nikon D5300 DSLR sa 18-55mm objektivom',
    description: 'Odličan DSLR fotoaparat za početnike i napredne amatere. Malo korišćen, isključivo za hobi. Oko 8000 okidanja. Uz aparat ide i torba, baterija i punjač.',
    price: 320,
    currency: 'EUR',
    category: 'elektronika',
    location: 'Beograd',
    condition: 'used',
    images: ['https://picsum.photos/seed/nikond5300/800/600'],
    postedDate: '2024-07-24T18:00:00Z',
    seller: { id: 'user-2', name: 'Jelena Jovanović', avatar: 'https://i.pravatar.cc/150?u=jelena', phone: '065 987 6543', email: 'jelena.j@example.com' }
  },
  {
    id: '65',
    title: 'DeLonghi aparat za espresso kafu',
    description: 'Aparat za espresso DeLonghi Magnifica S. Potpuno automatski, koristi kafu u zrnu. Ugrađen mlin. Redovno održavan i čišćen od kamenca. Pravi odličnu kafu.',
    price: 220,
    currency: 'EUR',
    category: 'kuca-i-basta',
    location: 'Novi Sad',
    condition: 'used',
    images: ['https://picsum.photos/seed/delonghi/800/600'],
    postedDate: '2024-07-24T20:00:00Z',
    seller: { id: 'user-3', name: 'Nikola Nikolić', avatar: 'https://i.pravatar.cc/150?u=nikola', phone: '061 111 2222', email: 'nikola.n@example.com' }
  },
...
/**
 * Retrieves the list of all listings from localStorage.
...
export const getAllListings = (): Listing[] => {
  try {
    ...
    return listingsJson ? (JSON.parse(listingsJson) as Listing[]) : [];
  } catch (error) {
...
/**
 * Saves a list of listings to localStorage.
 * @param listings The array of Listing objects to save.
 */
...
/**
 * Initializes the listings database in localStorage if it doesn't exist.
 */
const initializeListingsDatabase = (): void => {
  if (!localStorage.getItem(LISTINGS_DB_KEY)) {
 ...
 * @param newListing The new listing object to add.
 */
export const addNewListing = (newListing: Listing): void => {
